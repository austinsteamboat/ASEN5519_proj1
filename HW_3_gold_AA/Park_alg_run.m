...
% Initial Conditions
time_vec = 0;
FSM_case = 0; %FSM case, 0 is looking, 1 is found
X_dot_not = [0, 0, 0, 0]; % Initial Aircraft State Rates
X_not = [(X_traj(1,:)+[10, 10, -5]), 90*pi/180]; % Initial Aircraft State
...
for i = 1:Sim_dur
    % Start the Loop
    %
    % Calculate the Distance to find L1 point
